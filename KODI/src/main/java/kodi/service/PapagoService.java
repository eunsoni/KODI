...
public class PapagoService{
	...
	@Value("${papago.client.id:TEMP_CLIENT_ID}")
	private String clientId;
	
	@Value("${papago.client.secret:TEMP_CLIENT_SECRET}")
	...
	public String translateMsg(int memberIdx, int msgMemberIdx, String text) {
		...
		// API 키가 임시값인 경우 번역하지 않고 원본 텍스트 반환
		if ("TEMP_CLIENT_ID".equals(clientId) || "TEMP_CLIENT_SECRET".equals(clientSecret)) {
			System.out.println("[PapagoService] API 키가 설정되지 않아 번역을 건너뜁니다: " + text);
